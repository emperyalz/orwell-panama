...
- Media: daily free enrichment targets each profile's latest four items. Publisher article images are persisted to Convex; exact official outlet logos are local assets. Expired social URLs fall back to source links or supported embeds, without invented images.
