...
export default function Highlights(){return <div className="reference-world"><div className="reference-wrap explore-page"><header><span className="eyebrow">Panamá</span><h1>Actividad política</h1><p>Noticias, publicaciones y registros legislativos, reunidos desde sus fuentes.</p></header><ActivityFeed/><LegislativeFeed/></div></div>;}
