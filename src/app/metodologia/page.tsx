...
import {displayDate,PLATFORM_NAMES} from '@/lib/reference';
...
// Use the publisher's own mark in the visual directory. Names remain in alt text
// and link labels for screen readers and tooltips.
const publisherMarks: Record<string,string> = {
 ...
 'Mi Diario':'midiario.svg', 'ElCapitalFinanciero.com':'capitalfinanciero.jpg',
