...
export default async function PortraitReview(){
 ...
 return <div className="reference-world portrait-review"><div className="reference-wrap">
  <header className="portrait-review-intro"><span className="portrait-review-eyebrow">Revisión temporal · 24 septiembre 2026</span><h1>Retratos por revisar.</h1><p>Revisión de 16 perfiles: 8 sin fotografía y 8 con una imagen que no encajaba con la presentación del directorio. Aquí se comparan los retratos aprobados, los borradores y sus referencias.</p><nav aria-label="Secciones de retratos"><a href="#missing">Sin fotografía inicial · 8</a><a href="#replace">Por mejorar · 8</a></nav><p className="portrait-review-disclosure">Las fotos de referencia enlazan a sus fuentes. Los derechos de reutilización deben comprobarse antes de adoptar una foto o usarla como material de edición.</p></header>
