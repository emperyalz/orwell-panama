...
type Person={id:string;category:'missing'|'replace';name:string;role:string;province:string;headshot:string|null;hasHeadshot:boolean;references:StartingReference[]};
